...
func (db *DB) getMergePath() string {
	...
	return filepath.Join(dir, base+mergeDirName)    // /tmp/bitcask-merge
...
func (db *DB) loadMergeFiles() error {
	...
	for _, fileName := range mergeFileNames {
		srcPath := filepath.Join(mergePath, fileName)           // /tmp/bitcask-merge
		destPath := filepath.Join(db.options.DirPath, fileName) // /tmp/bitcask
